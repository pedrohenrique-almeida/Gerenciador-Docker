...
public class DockerService {
    ...
    public String listarContainers() {
        try {
            ...
            resposta.append("1️⃣ listar   2️⃣ iniciar\n");
            resposta.append("3️⃣ parar    4️⃣ logs\n\n");
            resposta.append("✍️ Uso: `[acao] [nome-ou-id]`\n");
            resposta.append("Ex: `2 pgadmin` | `3 api_whatsapp` | `4 redis`");
